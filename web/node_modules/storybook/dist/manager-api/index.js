...
} from "../_browser-chunks/chunk-7YGTGCDG.js";
import {
  BUILT_IN_FILTERS,
  Tag,
  USER_TAG_FILTER
} from "../_browser-chunks/chunk-2GLGVABT.js";
import {
  require_main
...
// src/manager-api/modules/stories.ts
var { fetch: fetch2 } = global6, STORY_INDEX_PATH = "./index.json", TAGS_FILTER = "tags-filter", STATIC_FILTER = "static-filter", getDefaultTagsFromPreset = (0, import_memoizerific2.default)(1)(
  (presets) => {
...
var init11 = ({
  ...
  let api = {
    ...
    addTagFilters: async (tags, excluded) => {
      let state = store2.getState(), newIncluded = new Set(state.includedTagFilters), newExcluded = new Set(state.excludedTagFilters);
      for (let tag of tags)
  ...
  let configFilters = provider.getConfig()?.sidebar?.filters || {}, tagPresets = global6.TAGS_OPTIONS || {}, defaultTags = getDefaultTagsFromPreset(tagPresets), persistedState = store2.getState(), initialIncluded = persistedState.includedTagFilters ?? persistedState.layout?.includedTagFilters ?? defaultTags.included, initialExcluded = persistedState.excludedTagFilters ?? persistedState.layout?.excludedTagFilters ?? defaultTags.excluded, initialFilters = {
    ...configFilters,
...
// src/manager-api/modules/versions.ts
var { VERSIONCHECK } = global8, getVersionCheckData = (0, import_memoizerific3.default)(1)(() => {
  try {
