...
// ------------------------------------------------------------
import "../../_node-chunks/chunk-T7U2FUWA.js";
import {
  doesStoryFileExist,
  generateStoryFile,
  getStoryMetadata,
...
import "../../_node-chunks/chunk-ZTT3ANLN.js";
import "../../_node-chunks/chunk-CHU3PQLW.js";
import "../../_node-chunks/chunk-UWL6FCZO.js";
import {
  isI18nPackage,
  isRouterPackage,
  isStateManagementPackage,
  isStylingPackage
} from "../../_node-chunks/chunk-4MHPXRYQ.js";
import {
  globalSettings
} from "../../_node-chunks/chunk-ZTC4BWCE.js";
import {
  invariant
...
import {
  glob
} from "../../_node-chunks/chunk-734OFJUC.js";
import "../../_node-chunks/chunk-DT5QWWL3.js";
import {
  require_dist
} from "../../_node-chunks/chunk-CXC3OGVY.js";
import "../../_node-chunks/chunk-AWPQVWBS.js";
import "../../_node-chunks/chunk-U7SRW327.js";
import {
  require_picocolors
...
var interpolate = (string, data = {}) => Object.entries(data).reduce((acc, [k, v]) => acc.replace(new RegExp(`%${k}%`, "g"), v), string), staticDirs = async (values = []) => [
  ...
  return faviconPaths.length > 1 && logger4.debug(import_ts_dedent.dedent`
  ...
  createIndex: async (fileName, options) => {
    let code = (await readFile4(fileName, "utf-8")).toString();
    return code.trim().length === 0 ? (logger4.debug(`The file ${fileName} is empty. Skipping indexing.`), []) : loadCsf(code, { ...options, fileName }).parse().indexInputs;
  }
